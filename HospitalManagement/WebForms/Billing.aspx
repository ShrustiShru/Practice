...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="server">
    <div class="container">
        <div class="row">
            ...
            <asp:TextBox runat="server" ID="txtPatientId" CssClass="form-control" Width="300px" /> &nbsp &nbsp &nbsp
            <asp:Button Text="Fetch" ID="btnFetch" CssClass="btn btn-secondary" runat="server" Width="100px" />
        </div>
        <hr />
        <div class="row">

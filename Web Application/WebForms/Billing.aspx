<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/MainMaster.Master" AutoEventWireup="true" CodeBehind="Billing.aspx.cs" Inherits="WebApplication.WebForms.Billing" %>
                ...
                <asp:ListView ID="lstCart" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%#Eval("Quantity") %></td>
                            <td><%#string.Format("{0:c}", Convert.ToInt32(Eval("ProductPrice")) * Convert.ToInt32(Eval("Quantity")))%></td>
                        </tr>
                    </ItemTemplate>
                </asp:ListView>
            </div>
